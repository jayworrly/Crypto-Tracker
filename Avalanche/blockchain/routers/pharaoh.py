...
# Load ABIs
pharaoh_json_path = os.path.join(current_directory, 'pharaoh.json')
uniswap_v3_json_path = os.path.join(current_directory, 'uniswapV3pool.json')

with open(pharaoh_json_path, 'r') as abi_file:
